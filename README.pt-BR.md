...
**Serviços suportados:** SQS · SNS · S3 · DynamoDB · Step Functions
...
Baixe a versão mais recente para sua plataforma em [GitHub Releases](https://github.com/lucascosta95/aws-local-manager/releases):
